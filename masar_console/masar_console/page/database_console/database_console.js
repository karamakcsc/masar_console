...
MyPage = Class.extend({
	...
	make: function(){
		...
		$(frappe.render_template(frappe.masar_database_console.body, this)).appendTo(this.page.main);
	  ...
	  document.head.appendChild(scrtag);
		...
		function makeQuery(formQuery){
			...
			frappe.call({
            method: "masar_console.masar_console.page.database_console.database_console.query_database", //dotted path to server method
